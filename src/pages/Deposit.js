...
export default function Deposit(props) {
  ...
  const onSubmit = async (e) => {
    ...
    var afterDeposit = account.balance + bal;

    const msg = `Deposit of ${bal} successful`;
    var transactionArray = account;
    transactionArray.transactionHistory.push(msg);
    console.log("transaction array ", transactionArray.transactionHistory);
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
          <h2 className="text-center text-primary">Deposit</h2>
